...
import useFetchDiscountedProductsQuery from "../../hooks/reactQuery/products/queries/useFetchDiscountedProductsQuery";
import { Spinner } from "../Spinner";
import { ProductSwiperCard } from "./ProductSwiperCard";

export const DiscountedProductsSwiper = () => {
  const { data, isLoading, isError, error } = useFetchDiscountedProductsQuery();
