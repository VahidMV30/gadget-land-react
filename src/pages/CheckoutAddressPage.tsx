...
const CheckoutAddressPage = () => {
  ...
  const { mutate, isPending } = useUpdateUserAddressInfoMutation();
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-16 w-full rounded border border-gray-300 p-4 lg:w-[45rem] dark:border-gray-700">
        <h4 className="mb-4 flex items-center justify-center gap-1.5 rounded bg-gray-200 p-4 text-center dark:bg-gray-800">
