...
import { LuKey, LuMail, LuUser, LuUserPlus } from "react-icons/lu";
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <div className="relative">
              <input
                type="password"
                placeholder="تائید گذرواژه"
                {...register("confirmPassword")}
                className={classnames(
                  "w-full rounded border border-gray-300 p-2 pr-10 outline-none focus:ring-2 dark:border-gray-700",
                  {
                    "border-rose-500 ring-rose-500 dark:border-rose-500": errors.confirmPassword,
                  },
                )}
                disabled={isPending}
              />
